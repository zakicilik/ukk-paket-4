...
<div class="glass-card p-4">
    <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <label class="form-label fw-semibold" style="color: var(--color-30);">
                    <i class="bi bi-lock me-1" style="color: var(--color-10);"></i> Password <span class="text-muted">(opsional)</span>
                </label>
                <input type="password"
                    name="password"
            ...
            <div class="col-md-6">
                <label class="form-label fw-semibold" style="color: var(--color-30);">
                    <i class="bi bi-lock-fill me-1" style="color: var(--color-10);"></i> Konfirmasi Password
                </label>
                <input type="password"
