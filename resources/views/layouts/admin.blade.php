    ...
    <style>
        * {
        ...
        .sidebar-header h3 {
            ...
            background: linear-gradient(120deg, var(--color-10), var(--color-10-light));
            -webkit-background-clip: text;
            background-clip: text;
            color: transparent;
            margin: 0;
        ...
        /* ========= PAGINATION ========= */
        .pagination {
            --bs-pagination-color: var(--color-10);
            --bs-pagination-active-bg: var(--color-10);
            --bs-pagination-active-border-color: var(--color-10);
            --bs-pagination-hover-color: var(--color-10-dark);
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        ...
        <div class="sidebar-sub">Perpustakaan Digital • Admin Panel</div>
    </div>
        ...
        <div class="user-profile">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <span class="fw-semibold text-light">{{ auth()->user()->name ?? 'Administrator' }}</span>
                    <div class="small text-light opacity-75">{{ auth()->user()->email ?? 'admin@libracore.id' }}</div>
                </div>
                <span class="badge-light-custom">ADMIN</span>
            </div>
        </div>
...
<!-- MAIN CONTENT AREA - 60% warna background -->
<div class="main-area">
    <div class="topbar d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div class="d-flex align-items-center gap-3">
            ...
            <h4 class="fw-bold mb-0">@yield('title', 'Dashboard Admin')</h4>
        </div>
        <div class="date-chip">
...
<div class="loading-overlay" id="loadingOverlay">
    <div class="text-center">
        ...
        <p class="mt-3 fw-medium text-secondary">Memuat antarmuka admin...</p>
    </div>
</div>
